...
#define TEST_ASSERT(A) if (A) { printf("\x1B[32mSUCCESS\x1B[0m\n"); } else { printf("\x1B[31mFAILED\x1B[0m\n"); }
#define TEST(T) printf("Running %s... ", #T); T()

/*
* three_vec3
*/
void test_three_vec3_length_sq()
{
...
void test_three_vec3_length_manhattan()
{
	struct three_vec3 vec1 = {10.0f, 20.0f, 30.0f};
...
void test_three_vec3_add_scalar()
{
	struct three_vec3 vec1 = {10.0f, 20.0f, 30.0f};
...
void test_three_vec3_mul_scalar()
{
	struct three_vec3 vec1 = {10.0f, 20.0f, 30.0f};
...
void test_three_vec3_div_scalar()
{
	struct three_vec3 vec1 = {10.0f, 20.0f, 30.0f};
...
void test_three_vec3_div_scalar_by_zero()
{
	struct three_vec3 vec1 = {10.0f, 20.0f, 30.0f};
...
void test_three_vec3_normalize()
{
	struct three_vec3 vec1 = {10.0f, 20.0f, 30.0f};
...
void test_three_vec3_set_length()
{
	struct three_vec3 vec1 = {10.0f, 20.0f, 30.0f};
...
void test_three_vec3_distance_to_sq()
{
	struct three_vec3 vec1 = {10.0f, 20.0f, 30.0f};
	struct three_vec3 vec2 = {1.0f, 2.0f, 3.0f};
...
void test_three_vec3_distance_to()
{
	struct three_vec3 vec1 = {10.0f, 20.0f, 30.0f};
	struct three_vec3 vec2 = {1.0f, 2.0f, 3.0f};
...
* three_vec4
*/
void test_three_vec4_length_sq()
{
	struct three_vec4 vec1 = {10.0f, 20.0f, 30.0f, 40.0f};
...
void test_three_vec4_length_manhattan()
{
	struct three_vec4 vec1 = {10.0f, 20.0f, 30.0f, 40.0f};
...
void test_three_vec4_mul_scalar()
{
	struct three_vec4 vec1 = {10.0f, 20.0f, 30.0f, 40.f};
...
void test_three_vec4_div_scalar()
{
	struct three_vec4 vec1 = {10.0f, 20.0f, 30.0f, 40.f};
...
void test_three_vec4_div_scalar_by_zero()
{
	struct three_vec4 vec1 = {10.0f, 20.0f, 30.0f, 40.f};
...
void test_three_vec4_normalize()
{
	struct three_vec4 vec1 = {10.0f, 20.0f, 30.0f, 40.f};
...
void test_three_vec4_set_length()
{
	struct three_vec4 vec1 = {10.0f, 20.0f, 30.0f, 40.0f};
...
void test_three_mat4_mul_scalar()
{
	struct three_mat4 mat1 = three_mat4(
		1.0f, 2.0f, 3.0f, 4.0f,
		5.0f, 6.0f, 7.0f, 8.0f,
...
void test_three_mat4_rotate_axis()
{
	struct three_mat4 mat1 = three_mat4(
		1.0f, 2.0f, 3.0f, 4.0f,
		5.0f, 6.0f, 7.0f, 8.0f,
...
{
	//Vector
	TEST(test_three_vec3_length_sq);
	TEST(test_three_vec3_length);
	TEST(test_three_vec3_length_manhattan);
	TEST(test_three_vec3_add);
	TEST(test_three_vec3_add_scalar);
	TEST(test_three_vec3_sub);
	TEST(test_three_vec3_mul);
	TEST(test_three_vec3_mul_scalar);
	TEST(test_three_vec3_div);
	TEST(test_three_vec3_div_scalar);
	TEST(test_three_vec3_div_scalar_by_zero);
	TEST(test_three_vec3_negate);
	TEST(test_three_vec3_dot);
	TEST(test_three_vec3_normalize);
	TEST(test_three_vec3_set_length);
	TEST(test_three_vec3_lerp);
	TEST(test_three_vec3_cross);
	TEST(test_three_vec3_angle_to);
	TEST(test_three_vec3_distance_to_sq);
	TEST(test_three_vec3_distance_to);
	TEST(test_three_vec3_fuzzy_eq);
	TEST(test_three_vec3_is_zero);
	TEST(test_three_vec4_length_sq);
	TEST(test_three_vec4_length);
	TEST(test_three_vec4_length_manhattan);
	TEST(test_three_vec4_add);
	TEST(test_three_vec4_sub);
	TEST(test_three_vec4_mul_scalar);
	TEST(test_three_vec4_div_scalar);
	TEST(test_three_vec4_div_scalar_by_zero);
	TEST(test_three_vec4_negate);
	TEST(test_three_vec4_dot);
	TEST(test_three_vec4_normalize);
	TEST(test_three_vec4_set_length);
	TEST(test_three_vec4_lerp);
	TEST(test_three_vec4_fuzzy_eq);

	//Matrix
	TEST(test_three_mat4_identity);
	TEST(test_three_mat4_fuzzy_eq);
	TEST(test_three_mat4_look_at);
	TEST(test_three_mat4_mul);
	TEST(test_three_mat4_mul_scalar);
	TEST(test_three_mat4_mul_vec3);
	TEST(test_three_mat4_mul_vec4);
	TEST(test_three_mat4_rotate_axis);
